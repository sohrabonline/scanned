...
public class ScannedPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "scanned", binaryMessenger: registrar.messenger())
    let instance = ScannedPlugin()
    registrar.addMethodCallDelegate(instance, channel: channel)
    registrar.register(ScanViewFactory(registrar: registrar), withId: "scan_view");
  }
